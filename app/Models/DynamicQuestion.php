...
class DynamicQuestion extends Model
{
    ...
    public function loadRelationshipsVideo()
    {
        return $this->load(
            [
                'files',
    ...
    public function loadRelationshipsStep()
    {
        return $this->load(
            [
                ...
                'exam',
                'exam.fcStep',
                'exam.fcStep.instance',
                'exam.fcStep.instance.forgettingCurve',
                'questionType',
                'alternatives' => fn ($query) =>
                $query->with(['file', 'droppableOption'])
            ]
    ...
    public function loadRelationShipFreeCourse()
    {
        return $this->load(
            [
                'files',
