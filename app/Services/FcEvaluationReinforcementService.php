...
class FcEvaluationReinforcementService
{
    ...
    public function show(FcStepProgress $fcStepProgress, $num_question)
    {
        ...
        if (
            !isset($evaluations[$num_question - 1]) || ($num_question > $selected_answers + 1) || $isFinished
        ) {
        ...
        if ($question->question_type_id == 5) {
            ...
            return view('aula.viewParticipant.forgettingCurve.evaluation.quizReinforcement', [
                'exam' => $exam,
                'num_question' => $num_question - 1,
                'question' => $question,
    ...
    public function update(FcStepProgress $fcStepProgress, Exam $exam, $num_question, $key, $evaluation)
    {
        ...
        $step = $fcStepProgress->step;
        $certification = $fcStepProgress->certification;

        return redirect()->route('aula.forgettingCurve.instances.evaluations.alternative.correct', ['step' => $step, 'certification' => $certification]);
    }
