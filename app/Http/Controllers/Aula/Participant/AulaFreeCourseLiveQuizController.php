...
class AulaFreeCourseLiveQuizController extends Controller
{
    private $quizService;
    ...
    public function show(Certification $certification, $num_question)
    {
        ...
        $current_date = Carbon::parse(getCurrentDate());
        ...
        if (!$its_time_out && !$current_date->lessThan($event_date)&& $certification->assist_user == 'S') {
            ...
            if ($question->question_type_id == 5) {
                ...
                return view('aula.common.live-free-courses.onlinelessons.evaluations.quiz', [
                    'exam' => $exam,
            ...
            return redirect()->route('aula.freeCourseLive.evaluations.index', $specCourse);
        }
    }
    ...
    public function start(Certification $certification)
    {
        ...
        if ($certification->evaluation_time == null) {
            ...
            if (
                $event->questions_qty <= $exam->questions_count &&
                ...
                return redirect()->route('aula.freeCourseLive.evaluations.index', ["course" => $event->course]);
            }
        }
        ...
        if ($certification->evaluation_time != null) {
            ...
            return redirect()->route('aula.freeCourseLive.evaluations.quiz.show', [
                'certification' => $certification,
                'num_question' => $num_question + 1
            ]);
        }
    ...
    public function update(Certification $certification, Exam $exam, $num_question, $key, $evaluation)
    {
        ...
        if (!$its_time_out && !$current_date->lessThan($event_date)) {
        ...
        $course = $certification->event->course;

        return redirect()->route('aula.freeCourseLive.evaluations.index', $course);
    }
