                                ...
                                <div class="form-group col-12 p-0 select-group">
                                    ...
                                    <div>
                                        <select name="course" class="form-control select2 select-filter-certification"
                                            data-url="{{ route('aula.supervisor.kpi.index') }}"
                        ...
                        <div class="card card-primary card-back">
                            ...
                            <div class="group-filter-buttons-section" style="gap: 1.5em; padding: 0 25px">
                                <div class="form-group col-12 p-0 select-group">
                                    <label class="form-label">Filtrar por curso: &nbsp;</label>
                                    <div>
                                        <select name="course_satisfaction"
                                            class="form-control select2 select-filter-satisfaction"
                                            data-url="{{ route('aula.supervisor.kpi.getSatisfactionKpi') }}"
                            ...
                            <div class="card-body">
                                ...
                                <canvas data-satisfaction="{{ $satisfaction }}" id="chart-satisfaction"
                                    style="height: 270px;">
                                </canvas>
                            </div>
                        </div>
