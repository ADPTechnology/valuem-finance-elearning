            ...
            <div class="options-container">
                ...
                <section id="draggable-section">
                    ...
                    @foreach ($alts_ids as $alt_id)
                        ...
                        <div class="drag {{ $image_url == null ? 'without_image' : '' }}@if (in_array($alt_id, $only_selected)) dragged dropped @endif"
                            id='{{ $alt_id }}'>
                ...
                <section id="droppable-section">
                    ...
                    @foreach ($options_ids as $option_id)
                        ...
                        <div class="droppable-option">
                            <div class="drop @if ($trigger_selected) dropped @endif" draggable="false"
                                id="option-{{ $option_id }}">
                                ...
                                @if ($trigger_selected)
                                    <div class="drag drag-drop" id="{{ $opt_and_alt_array[1] }}"
            ...
            <div class="btn-save">
                ...
                @if ($num_question + 1 == count($evaluations))
                    <button type="submit" id="submit"
                        class="hs-button primary large action-button next save-matching" value="Finalizar">
