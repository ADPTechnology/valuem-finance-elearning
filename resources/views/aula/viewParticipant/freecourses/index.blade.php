                    ...
                    <div class="card course-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="start-button-container freecourses">
                                <form method="POST"
                                    action="{{ route('aula.freecourse.start', ['course' => $recomendedCourse]) }}">
                                    @csrf
                                    <button type="submit">
                                        Ingresar &nbsp;
                            ...
                            <div class="course-info-box">
                                <div class="hours-box">
                                    ...
                                    Duración: {{ $recomendedCourse->hours }} hrs.
                                </div>
                            </div>
                ...
                <div class="courses-cards-container">
                    ...
                    <div class="card course-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="start-button-container freecourses">
                                <form method="POST"
                                    action="{{ route('aula.freecourse.start', ['course' => $pendingCourse]) }}">
                                    @csrf
                                    <button type="submit">
                                        Continuar &nbsp;
                                        <i class="fa-solid fa-chevron-right"></i>
                            ...
                            <div class="course-info-box">
                                <div class="hours-box">
                                    <i class="fa-regular fa-clock"></i>
                                    Duración: {{ $pendingCourse->hours }} hrs.
                                </div>
                            </div>
                ...
                @forelse ($finishedCourses as $finishedCourse)
                    <div class="card course-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="start-button-container freecourses">
                                <form method="POST"
                                    action="{{ route('aula.freecourse.start', ['course' => $finishedCourse]) }}">
                                    @csrf
                                    <button type="submit">
                                        Ingresar &nbsp;
                                        <i class="fa-solid fa-chevron-right"></i>
                            ...
                            <div class="course-info-box">
                                <div class="hours-box">
                                    <i class="fa-regular fa-clock"></i>
                                    Duración: {{ $finishedCourse->hours }} hrs.
                                </div>
                            </div>
