                ...
                <div class="signature-pad--footer">
                    ...
                    <div class="signature-pad--actions">
                        <div class="button-section-1">
                            <button type="button" class="button clear btn btn-primary" data-action="clear">Volver a
                                Firmar </button>
                            <button type="button" class="button clear btn btn-secondary" data-action="undo">Corregir
                                Firma</button>
                        </div>
                        <div class="button-section-2">
                            <button id="btn_save_signature" data-url="{{ route('aula.signatures.store') }}" type="button"
                                class="button save btn btn-success" data-action="save-png">Guardar
                                Firma
                            </button>
                        </div>
                    </div>
