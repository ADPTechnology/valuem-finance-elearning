    ...
    <div class="content global-container">
        ...
        <div class="card-body body-global-container card z-index-2 principal-container">
            ...
            <div class="row navigation-boxes-container">
                ...
                <a href="{{ route('aula.webinar.onlinelesson.index', $webinar) }}" class="link-box-navigation-course">
                ...
                <a href="{{ route('aula.webinar.resources.index', $webinar) }}" class="link-box-navigation-course">
                    <div class="navigation-box online-lesson card">
                        <div class="img-container">
                ...
                {{--
                @can('denyInstructor')
                    <a href="{{ route('aula.freeCourseLive.evaluations.index', $webinar) }}" class="link-box-navigation-course">
                        ...
                        <div id="groups-list-container" class="related-dropdown-container" style="">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($webinar->events as $event)
                                        <tr>
                                            <th scope="row">{{ $event->id }}</th>
                                            <td>
                                                <a href="{{ route('aula.webinar.events.show', $event) }}">
                                                    {{ $event->description }}
                                                </a>
                                            </td>
