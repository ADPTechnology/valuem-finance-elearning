        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            <i class="fa-solid fa-file-lines text-primary mb-4 fa-3x"></i>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            <i class="fa-solid fa-person-chalkboard text-primary mb-4 fa-3x"></i>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100"
                            src="{{ asset('assets/home/img/hama-elarning.png') }}" alt=""
                            style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">Acerca de nosotros</h6>
                    <h1 class="">¡Bienvenidos a</h1>
                    <h1 class="mb-4">HAMA E-Learning!</h1>
                    <p class="mb-4">Somos una plataforma dedicada a la educación en línea, comprometida con el crecimiento
                        y desarrollo de nuestros estudiantes. Nuestro objetivo es proporcionar un aprendizaje accesible,
                        asequible y de alta calidad para todos, independientemente de dónde se encuentren.</p>
                    <p class="mb-4">En Hama E-Learning, creemos en el poder de la educación para transformar vidas.
                        Nuestros cursos están diseñados para ser interactivos, atractivos y fáciles de entender, permitiendo
                        ...
                        <div class="team-item bg-light-primary">
                            ...
                            <div class="information w-100 d-flex">
                                <button class="btn btn-primary get-information-btn w-100"
                                    data-url="{{ route('home.about.getInformationInstructor', $instructor->id) }}">
...
@section('modals')
    @include('home.common.partials.modals._information_instructor')
@endsection

@section('extra-script')
    <script src="{{ asset('assets/home/js/instructor.js') }}"></script>
@endsection
