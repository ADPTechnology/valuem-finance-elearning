<div class="container">
    ...
    @foreach ($events as $event)
        @php
            ...
            $participants_ids = $event->certifications()->pluck('user_id')->toArray();
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="{{ $delay }}s">
            <div class="course-item bg-light-primary">
                <div class="position-relative image-inner-container overflow-hidden">
                    @php
                        $imageUrl = $event->file ? verifyImage($event->file) : asset('assets/home/img/course-event-default.jpg');
                    @endphp
                    ...
                    @can('allowExternal')
                        <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                            ...
                            @elseif ($event->certifications->count() < $event->room->capacity)
                                <a href="#"
                                    @auth data-url="{{ route('home.certifications.userExternalSelfRegister', $event) }}" @endauth
                ...
                <div class="d-flex flex-column border-top">
                    <small
                        ...
                        <span>
                            ...
                            {{ ucwords(strtolower($event->instructor->full_name)) }}
                ...
                <div class="d-flex border-top">
                    ...
                    <small class="flex-fill text-center py-2">
                        ...
                        {{ $event->room->capacity - $event->certifications->count() }}
