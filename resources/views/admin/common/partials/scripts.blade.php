...
<script src="{{ asset('assets/common/js/filepond/filepond.js') }}"></script>
...
<script src="{{ asset('assets/common/js/filepond/filepong-file-size.js') }}"></script>
...
<script type="module" src="{{ asset('assets/admin/js/custom.js') }}"></script>
