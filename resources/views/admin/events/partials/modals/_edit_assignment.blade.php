<div class="modal fade" id="editAssignmentModal" tabindex="-1" aria-labelledby="editAssignmentModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable ">
        <div class="modal-content">
            ...
            <form action="" id="edit-assignment-form" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group d-flex mb-0 after">
                        <div class="form-group col-6">
                            <label>Evaluable</label>
                            <div>
                                <label class="custom-switch mt-2">
