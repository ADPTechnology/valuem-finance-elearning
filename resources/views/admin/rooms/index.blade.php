    ...
    <div class="row content">
        ...
        <div class="main-container-page">
            ...
            <div class="card-body card z-index-2 principal-container">
                ...
                <form action="{{ route('admin.rooms.exportExcel') }}" id="form-rooms-export" method="GET">
                    <div class="mb-4">
    ...
    <div class="modal fade" id="RegisterRoomModal" tabindex="-1" aria-labelledby="RegisterRoomModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.rooms.store') }}" id="registerRoomForm" method="POST"
                    data-validate='{{ route('admin.rooms.registerValidateName') }}'>
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input name="url" type="text" class="form-control" placeholder="Ingrese url">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="custom-switch mt-2">
                                <input type="checkbox" name="roomStatusCheckbox" id="register-room-status-checkbox" checked
            ...
            <div class="modal-content">
                ...
                <form id="editRoomForm" method="POST" data-validate='{{ route('admin.rooms.editValidateName') }}'>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="custom-switch mt-2">
                                <input type="checkbox" name="roomStatusCheckbox" id="edit-room-status-checkbox" checked
                                    class="custom-switch-input">
                                <span class="custom-switch-indicator"></span>
