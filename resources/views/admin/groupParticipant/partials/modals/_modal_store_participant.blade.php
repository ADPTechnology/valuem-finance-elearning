<div class="modal fade" id="registerParticipantsModal" tabindex="-1" aria-labelledby="registerParticipantsModal"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <form
                action="{{ route('admin.specCourses.groupEvents.groupParticipants.addParticipantsOnGroup', $groupParticipant) }}"
                id="register-participants-form" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <table id="users-participants-table" class="table table-hover"
                            data-url="{{ route('admin.specCourses.groupEvents.groupParticipants.getPotentialParticipants', $groupParticipant) }}">
                        <thead>
                            <tr>
                                <th>Elegir</th>
                                <th>N°</th>
