    ...
    <div class="row content">
        ...
        <div class="main-container-page">
            ...
            <div class="card-body card z-index-2 principal-container">
                ...
                <form action="{{ route('admin.exams.exportExcel') }}" id="form-exams-export" method="GET">
                    <div class="mb-4">
                            ...
                            <div class="form-group col-12">
                                ...
                                <div class="input-group">
                                    <select name="course_id" class="form-control select2" id="registerCourseSelect">
                                        <option></option>
                                        <optgroup label="CURSOS LIBRES EN VIVO">
                                            @foreach ($freeliveCourses as $course)
                                        ...
                                        <optgroup label="CURSOS REGULARES">
