<div class="info-element-general-container">
    ...
    <div class="action-box info-element-box">
        ...
        <div class="btn-action-container">
            <span id="exam-edit-btn" class="edit-btn" data-url="{{ route('admin.exams.update', $exam) }}"
                data-send="{{ route('admin.exams.edit', $exam) }}">
                <i class="fa-solid fa-pen-to-square"></i>
            </span>
            @if ($exam->questions_count == 0 && $exam->events_count == 0)
                <span class="delete-btn delete-exam-btn" data-url="{{ route('admin.exams.destroy', $exam) }}">
