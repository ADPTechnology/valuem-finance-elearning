@if ($files->count() == 0)
    <section class="mt-1 mb-1">
        <div class="alert alert-warning">
            ...
            &nbsp;
            Aún no se han cargado documentos para esta empresa.
        </div>
    </section>
@else
            ...
            @foreach ($files as $file)
                <tr>
                    ...
                    <td class="text-center">
                        <a data-id="{{ $file->id }}" href="{{ route('admin.companies.downloadDocument', $file) }}"
                    ...
                    <td class="text-center">
                        <button data-id="{{ $file->id }}" data-original-title="delete"
                            type="button"
                            data-url="{{ route('admin.companies.deleteDocument', ['file' => $file, 'company' => $company]) }}"
