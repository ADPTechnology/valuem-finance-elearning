    ...
    <div class="row content">
        ...
        <div class="main-container-page">
            ...
            <div class="card-body card z-index-2 principal-container">
                ...
                <form action="{{ route('admin.ownerCompanies.exportExcel') }}" id="form-companies-export" method="GET">
                ...
                <table id="ownerCompanies-table" class="table table-hover"
                    data-url="{{ route('admin.ownerCompanies.index') }}">
                    <thead>
                        <tr>
                            <th>N°</th>
                            <th>Nombre</th>
...
@section('modals')
    <div class="modal fade" id="RegisterCompanyModal" tabindex="-1" aria-labelledby="RegisterCompanyModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.ownerCompanies.store') }}" id="registerCompanyForm" method="POST"
                    data-validate='{{ route('admin.ownerCompany.registerValidate') }}'>
                    @csrf
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="" id="EditCompanyForm" method="POST"
                    data-validate='{{ route('admin.ownerCompanies.editValidate') }}'>
                    @csrf
