<div class="modal fade" id="EditExamModal" tabindex="-1" aria-labelledby="EditExamModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="RegisterCompanyModalLabel">
                    <div class="section-title mt-0">
                        ...
                        Editar Examen: <span id="titleExam"></span>
                    </div>
                </h5>
            ...
            <form action="" id="edit-free-courses-exams-form" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="custom-switch mt-2">
                            <input type="checkbox" name="active" id="edit-exam-free-course-status-checkbox"
                                class="custom-switch-input">
                            <span class="custom-switch-indicator"></span>
                            <span id="txt-edit-description-exam-free-course"
