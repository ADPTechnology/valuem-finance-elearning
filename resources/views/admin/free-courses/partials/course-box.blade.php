...
<div class="info-element-general-container">
    ...
    <div class="extra-info-container">
        ...
        <div class="counts-cont text-no-wrap">
            ...
            <div class="chapters-cont">
                <span class="little-text little-text-width">Lecciones: </span>
                <span class="text-bold">
        ...
        <div>
            <div class="little-text">Nota mínima: </div>
            <span>
                {{ $course->min_score ?? 0 }}
            </span>
        </div>
    ...
    <div class="element-status-cont">
        ...
        <div class="duration-cont">
            ...
            <div class="text-no-wrap">
                {{ getFreeCourseTime(round(($course->hours ?? 0) * 60)) }}
            </div>
        </div>
        <div class="duration-cont">
            <span class="little-text">
            ...
            <div class="text-no-wrap">
                @php
                    $duration = $course->course_chapters_sum_duration + $course->exams_duration;
                @endphp
                {{ getFreeCourseTime($duration) }}
            </div>
        </div>
    ...
    <div class="action-box info-element-box">
        <div class="btn-action-container">
            <span id="freecourse-edit-btn" class="edit-btn"
                data-send="{{ route('admin.freeCourses.courses.edit', $course) }}">
