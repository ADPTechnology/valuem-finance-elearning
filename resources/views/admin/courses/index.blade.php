    ...
    <div class="row content">
        ...
        <div class="main-container-page">
            ...
            <div class="card-body card z-index-2 principal-container">
                ...
                <form action="{{ route('admin.courses.exportExcel') }}" id="form-course-export" method="GET">
                    <div class="mb-4">
...
@section('modals')
    <div class="modal fade" id="RegisterCourseModal" tabindex="-1" aria-labelledby="RegisterCourseModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.courses.store') }}" id="registerCourseForm" enctype="multipart/form-data"
                ...
                <form action="" id="editCourseForm" enctype="multipart/form-data" method="POST"'>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label>Horas</label>
                                <input type="number" name="hours" step="0.1" min="0.1"
                                    class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div>
                                    <div id="image-preview" class="image-preview">
                                        <label for="image-upload" id="image-label">Subir Imagen</label>
                                        <input type="file" name="image" id="input-course-image-update"
                                            data-value="">
                                        <div class="img-holder">
