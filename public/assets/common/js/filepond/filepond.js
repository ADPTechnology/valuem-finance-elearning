...
!(function (e, t) {
                    ...
                    E = n({
                        interpolate: function (n, r) {
                            f ||
                                null === p ||
                                (null === c && (c = n),
                                    n - c < l || ((e = n - c - l) >= i || r ? ((e = 1), (t = d ? 0 : 1), E.onupdate(t * p), E.oncomplete(t * p), (f = !0)) : ((t = e / i), E.onupdate((e >= 0 ? s(d ? 1 - t : t) : 0) * p))));
                        },
                        target: {
                            get: function () {
                                return d ? 0 : p;
    ...
    var ce,
        ...
        rt = function (e, t, n) {
            var r = {
                ...
                o = !1,
                i = !1;
            (n = Object.assign({ method: "POST", headers: {}, withCredentials: !1 }, n)), (t = encodeURI(t)), nt(n.method) && e && (t = "" + t + encodeURIComponent("string" == typeof e ? e : JSON.stringify(e)));
                            ...
                            (i.source = t),
                                ...
                                i.file
                                    ...
                                    : ((i.file = (function (e) {
                                        ...
                                        return (
                                            e instanceof Blob || Ye(e) ? (t[0] = e.name || Xe()) : Ye(e) ? ((t[1] = e.length), (t[2] = Qe(e))) : U(e) && ((t[0] = ke(e)), (t[1] = 0), (t[2] = "application/octet-stream")),
        ...
        Pt = function (e, t, n) {
            return {
                    ...
                    if (M(o)) f({ error: ot("error", 0, "No source"), file: null });
                        ...
                        v.on("init", function () {
                            ...
                            v.on("load-request-error", function (t) {
                                ...
                                if (t.code >= 400 && t.code < 500) return e("DID_THROW_ITEM_INVALID", { id: h, error: t, status: { main: r, sub: t.code + " (" + t.body + ")" } }), void f({ error: t, file: Te(v) });
                            ...
                            v.on("process-error", function (t) {
                                e("DID_THROW_ITEM_PROCESSING_ERROR", { id: h, error: t, status: { main: Dt(n.options.labelFileProcessingError)(t), sub: n.options.labelTapToRetry } });
                            }),
                            v.on("process-revert-error", function (t) {
                                e("DID_THROW_ITEM_PROCESSING_REVERT_ERROR", { id: h, error: t, status: { main: Dt(n.options.labelFileProcessingRevertError)(t), sub: n.options.labelTapToRetry } });
                            }),
                ...
                COMPLETE_LOAD_ITEM: function (r) {
                    ...
                    if ((Y(u) && s && Lt(n, u), e("DID_LOAD_ITEM", { id: o.id, error: null, serverFileReference: o.origin === ve.INPUT ? null : s }), a(Te(o)), o.origin !== ve.LOCAL))
                        return o.origin === ve.LIMBO
                            ? (e("DID_COMPLETE_ITEM_PROCESSING", { id: o.id, error: null, serverFileReference: s }), void e("DID_DEFINE_VALUE", { id: o.id, value: o.serverId || s }))
                ...
                REQUEST_ITEM_PROCESSING: bt(n, function (r, o, i) {
                    if (r.status === Ie.IDLE || r.status === Ie.PROCESSING_ERROR)
                        r.status !== Ie.PROCESSING_QUEUED && (r.requestProcessing(), e("DID_REQUEST_ITEM_PROCESSING", { id: r.id }), e("PROCESS_ITEM", { query: r, success: o, failure: i }, !0));
                    else {
                        var a = function () {
                    ...
                    r.origin === ve.LOCAL && u && Y(u.remove) && !1 !== a.remove
                        ? (e("DID_START_ITEM_REMOVE", { id: r.id }),
                            u.remove(
                                ...
                                function (t) {
                                    e("DID_THROW_ITEM_REMOVE_ERROR", { id: r.id, error: ot("error", 0, t, null), status: { main: Dt(n.options.labelFileRemoveError)(t), sub: n.options.labelTapToRetry } });
                                }
                            ))
                        : (((a.revert && r.origin !== ve.LOCAL && null !== r.serverId) || (n.options.chunkUploads && r.file.size > n.options.chunkSize) || (n.options.chunkUploads && n.options.chunkForce)) &&
    ...
    var Kt,
        ...
        sn = {
            ...
            DID_THROW_ITEM_REMOVE_ERROR: { processProgressIndicator: { opacity: 0, align: nn }, buttonRemoveItem: { opacity: 1 }, info: { translateX: $t }, status: { opacity: 1, translateX: $t } },
            DID_LOAD_ITEM: on,
        ...
        vn = A(
            ...
            function (e) {
                ...
                a ? o || (t.height = t.rect.element.width * a) : (In({ root: t, actions: n, props: r }), !t.height && t.ref.container.rect.element.height > 0 && (t.height = t.ref.container.rect.element.height)),
        ...
        bn = S({
            ...
            write: function (e) {
                var t = e.root,
                    n = e.props,
                    r = e.actions;
                if ((Ln({ root: t, props: n, actions: r }), (t.ref.list.dragCoordinates = n.dragCoordinates), n.overflowing && !n.overflow && ((n.overflowing = !1), (t.element.dataset.state = ""), (t.height = null)), n.overflow)) {
        ...
        Xr = function (e, t) {
            var n = e.query("GET_ALLOW_REPLACE"),
                ...
                a = t.length;
            return !r && a > 1
                ? (e.dispatch("DID_THROW_MAX_FILES", { source: t, error: ot("warning", 0, "Max files") }), !0)
                : !(!r && n) && !!(V((i = r ? i : 1)) && o + a > i) && (e.dispatch("DID_THROW_MAX_FILES", { source: t, error: ot("warning", 0, "Max files") }), !0);
        },
        Wr = function (e, t, n) {
    ...
    if (((e.Status = {}), (e.FileStatus = {}), (e.FileOrigin = {}), (e.OptionTypes = {}), (e.create = _o), (e.destroy = _o), (e.parse = _o), (e.find = _o), (e.registerPlugin = _o), (e.getOptions = _o), (e.setOptions = _o), po())) {
        ...
        var To = function t() {
            document.dispatchEvent(new CustomEvent("FilePond:loaded", { detail: { supported: po, create: e.create, destroy: e.destroy, parse: e.parse, find: e.find, registerPlugin: e.registerPlugin, setOptions: e.setOptions } })),
