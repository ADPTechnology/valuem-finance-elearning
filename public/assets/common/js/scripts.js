...
$(function () {
    ...
    var toggle_sidebar_mini = function (mini) {
        ...
        if (!mini) {
            ...
            $(".sidebar-menu .home-button").css({
                display: "none",
            });
            $("#modules-title-admin").css({
                display: "flex",
            });
            $("#sidebar-wrapper").css({
                width: "100%",
            });
            $("body .main-sidebar .sidebar-menu > li").css({
                width: "100%",
            });
            $(".name").css({
                fontSize: "1.5em",
            ...
            $(".outside-container-image-avatar").css({
                width: "125px",
                height: "125px",
            });

            $(".user-profile-presentation-cont").css({
            ...
            $("#icon-information").css({
                display: "none",
            });

            $(".img-profile-page-box").css({
                height: "100%",
            });
