...
import { SwalDelete, Toast, ToastError } from "../../common/js/sweet-alerts.js";
...
$(function () {
    ...
    $("html").on("click", ".btn-dropdown-container", function () {
        ...
        var actionButtonContainer = parent.find(
            ".action-btn-dropdown-container.outside"
        );
    ...
    if ($("#companies-table").length) {
        ...
        $(".main-content").on("click", ".editCompany", function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    modal
                        .find("input[name=abreviation]")
                        .val(data.abbreviation);
                    modal.find("input[name=rubric]").val(data.rubric);
                    ...
                    modal
                        .find("input[name=referPhone]")
                        .val(data.telephone_ref);
                    modal.find("input[name=referEmail]").val(data.email_ref);

                    if (data.active == "S") {
                        modal
                            .find("#edit-company-status-checkbox")
                            .prop("checked", true);
        ...
        $("html").on("click", ".showDocsCompany", function () {
            var button = $(this);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    let companyTitle = data.title;
                    let html = data.html;
                    let companyTitleCont = modal.find(
                        ".modal_docs_company_name"
                    );
                    let modalDocsBody = modal.find("#tableDocs");
                    companyTitleCont.html(companyTitle + ": ");
        ...
        $(".main-content").on("click", ".editRoom", function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.active == "S") {
                        modal
                            .find("#edit-room-status-checkbox")
                            .prop("checked", true);
        ...
        $(".main-content").on("click", ".editCourse", function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == "S") {
                        modal
                            .find("#edit-course-status-checkbox")
                            .prop("checked", true);
    ...
    if ($("#freeCourses-table").length) {
        ...
        function getSummernoteConfig(summernoteElement, cardForm) {
            return {
                dialogsInBody: true,
                minHeight: 360,
                placeholder: "Escribe aqui la descripción del curso...",
        ...
        var freeCoursesTable = freeCoursesTableEle.DataTable({
            ...
            columns: [
                ...
                { data: "subtitle", name: "subtitle" },
                {
                    data: "course_category.description",
                    name: "courseCategory.description",
                    orderable: false,
                },
        ...
        $(".main-content").on("click", ".editCategory-btn", function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == "S") {
                        modal
                            .find("#edit-category-status-checkbox")
                            .prop("checked", true);
        ...
        freeCourseImageRegister.on("change", function () {
            var img_path = $(this)[0].value;
            var img_holder = $(this)
                .closest("#registerFreeCourseForm")
                .find(".img-holder");
            var img_extension = img_path
                .substring(img_path.lastIndexOf(".") + 1)
                .toLowerCase();
            ...
            if (
                ...
                if (typeof FileReader != "undefined") {
                    ...
                    reader.onload = function (e) {
                        $("<img/>", {
                            src: e.target.result,
                            class: "img-fluid freecourse_img",
                        }).appendTo(img_holder);
                    };
                    img_holder.show();
                    reader.readAsDataURL($(this)[0].files[0]);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            ...
                            modal
                                .find("textarea[name=description_details]")
                                .empty();
        ...
        $("#RegisterfreeCourseModal").on("show.bs.modal", function () {
            $("#card-content-register").summernote(
                getSummernoteConfig(
                    $("#card-content-register"),
                    registerFreeCourseForm
            ...
            $(this).find("textarea[name=description_details]").empty();
        });
        $("#RegisterfreeCourseModal").on("hidden.bs.modal", function () {
            $("#card-content-register").summernote("destroy");
            $(this).find("textarea[name=description_details]").empty();
        });
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var modalDescription = $(
                            "#category-description-register-modal"
                        );
    ...
    if ($("#course-box-container").length) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            ...
                            var descriptionCont = $(
                                "#course-description-text-principal"
                            );
        ...
        $("html").on("click", "#freecourse-edit-btn", function () {
            var button = $(this);
            var getDataUrl = button.data("send");
            var modal = $("#editFreeCourseModal");
            let form = modal.find("#editFreeCourseForm");
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    modal.find("input[name=min_score]").val(data.min_score);

                    modal
                        .find("textarea[name=description_details]")
                        .val(data.description_details);
                    ...
                    setActiveCheckBoxForResult(
                        form,
                        "#edit-course-status-checkbox",
                        "#txt-edit-description-course",
                        data.status
                    );

                    setActiveCheckBoxForResult(
                        form,
                        "#edit-course-recom-checkbox",
                        null,
                        data.recom
                    );
                },
        ...
        $("#editFreeCourseModal").on("show.bs.modal", function () {
            $("#card-content-register").summernote(
                getSummernoteConfig(
                    $("#card-content-register"),
                    editFreeCourseForm
        ...
        $("#editFreeCourseModal").on("hidden.bs.modal", function () {
            $("#card-content-register").summernote("destroy");
            $(this).find("textarea[name=description_details]").empty();
        });
        ...
        // ADD EXAMEN TO SECTION

        const EXAM_TO_SELECT_CONFIG = {
        ...
        $("html").on("click", ".section-question-btn", function () {
            var button = $(this);
            var getDataUrl = button.data("send");
            var url = button.data("url");

            var modal = $("#assignExamToSectionModal");
            var form = modal.find("#assignExamToSectionForm");

            var modalBodyRender = $("#modalBodyRender");
            modalBodyRender.html("");
            ...
            $.ajax({
                ...
                dataType: "JSON",
                success: function (data) {
                    modalBodyRender.html(data.html);
        ...
        var assignExamToSectionForm = $("#assignExamToSectionForm").validate({
            rules: {
                exam_id: {
                    required: true,
                },
            ...
            submitHandler: function (form, event) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            haveExam = data.haveExam;

                            assignExamToSectionForm.resetForm();
        ...
        $(".main-content").on("click", ".editExam-btn", function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (exam.active == "S") {
                        modal
                            .find("#edit-exam-status-checkbox")
                            .prop("checked", true);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            ...
                            var title_cont = $(
                                "#exam-description-text-principal"
                            );
    ...
    if ($("#question-type-container").length) {
        ...
        function deleteAlternative(row, questionType) {
            ...
            $("tr.alternative-row").each(function (index) {
                ...
                if (questionType == 5) {
                    $(this)
                        .find(".image-icon-alternative label")
                        .attr("for", "alternative-image-" + index);
                    $(this)
                        .find("input[type=file].input-alternative-image")
        ...
        function deleteImage(row) {
            ...
            column
                .find(".image-icon-alternative .inner-icon-context")
                .html('<i class="fa-solid fa-plus fa-xs"></i>');
            ...
            function () {
                ...
                if (questionType == 1) {
                    if ($("#questions-table").length) {
                        ...
                        row.find(".delete-btn")
                            .removeClass("delete-alternative-btn")
                            .addClass("disabled");
                        row.siblings()
                            .find(".delete-btn")
                            .removeClass("disabled")
                            .addClass("delete-alternative-btn");
                    }
                }
            }
        );
    ...
    if ($("#events-table").length) {
        ...
        if ($("#registerEventForm").length) {
            ...
            $(".main-content").on(
                ...
                function () {
                    ...
                    var instructorSelect = form.find(
                        "#registerInstructorSelect"
                    );
                    var responsableSelect = form.find(
                        "#registerResponsableSelect"
                    );
                    var roomSelect = form.find("#registerRoomSelect");
                    var ownerCompanySelect = form.find(
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            form.find("input[name=questions_qty]")
                                .val("")
                                .attr("disabled", "disabled")
                                .addClass("input-disabled");
                            form.find("input[name=min_score]")
                                .val("")
                                .attr("disabled", "disabled")
                                .addClass("input-disabled");
        ...
        if ($("#editEventForm").length) {
            ...
            $("html").on("click", ".editEvent-btn", function () {
                var getDataUrl = $(this).data("send");
                var url = $(this).data("url");
                var modal = $("#editEventModal");
                ...
                var flgSurveyEvaluation = form.find(
                    "#edit-flg-survey-evaluation"
                );
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        form.find("input[name=record_url]").val(event.record_url)
                        ...
                        let inputQuestionQty = form.find(
                            "input[name=questions_qty]"
                        );
                        ...
                        form.find("#info-qty-questions").html(
                            infoQtyText(questQty)
                        );
                        form.find("#info-min-score").html(
                            infoScoreText(maxScore)
                        );
        ...
        $("html").on("click", ".deleteEvent-btn", function () {
            var url = $(this).data("url");
    ...
    if ($("#certifications-table").length) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.success) {
                                ...
                                $("#event-description-text-principal").html(
                                    data.title
                                );
                                certificationsTable.ajax.reload(null, false);
                                editEventForm.resetForm();
            ...
            $("html").on("click", ".editEvent-btn", function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        form.find("input[name=record_url]").val(
                            event.record_url
                        );
        ...
        $(".main-content").on("click", ".showCertification-btn", function () {
            ...
            var bodyCertification = modal.find(
                "#certification-info-table tbody"
            );
        ...
        $(".main-content").on("click", ".editCertification-btn", function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    form.find("input[name=observation]").val(
        ...
        var registerParticipantsMassiveForm = $(
            "#registerParticipantsMassiveForm"
        ).validate({
            rules: {
                file: {
                    required: true,
        ...
        var registerParticipantsScoreForm = $(
            "#registerParticipantsScoreForm"
        ).validate({
            rules: {
                file: {
                    required: true,
        ...
        var registerParticipantsAreaForm = $(
            "#registerParticipantsAreaForm"
        ).validate({
            rules: {
                file: {
                    required: true,
    ...
    if ($("#publishings-table").length) {
        ...
        $("#registerCardModal").on("show.bs.modal", function () {
            summernoteElement.summernote(
                getSummernoteConfig(summernoteElement, cardForm)
            );
        ...
        $(".main-content").on("click", ".editCard", function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (card.status == 1) {
                        modal
                            .find("#edit-card-status-checkbox")
                            .prop("checked", true);
                    } else {
                        modal
                            .find("#edit-card-status-checkbox")
        ...
        $("#editCardModal").on("show.bs.modal", function () {
            summernoteEditElement.summernote(
                getSummernoteConfig(summernoteEditElement, cardEditForm)
            );
        });
                    ...
                    success: function (data) {
                        if (data.success) {
                            if (data.location == "show") {
                                $("#survey-name-text-principal").html(
                                    data.title
                                );
        ...
        $(".main-content").on("click", ".editSurvey", function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    modal
                        .find("input[name=destined_to]")
                        .val(survey.destined_to);
                    modal
                        .find($("#input_destined_type"))
                        .html(data.destined_to);
                    modal
                        .find(".img-holder")
                        .html(
                    ...
                    if (survey.active == "S") {
                        modal
                            .find("#edit-survey-status-checkbox")
                            .prop("checked", true);
            ...
            submitHandler: function (form, event) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            if (data.location == "show") {
                                $("#group-name-text-principal").html(
                                    data.title
                                );
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            ...
                            $("#title-statement-container").html(
    ...
    if ($("#profile-surveys-table").length) {
        ...
        profileSurveysTable = profileSurveysTableEle.DataTable({
            ...
            ajax: {
                url: getDataUrl,
                data: function (data) {
                    data.from_date = $("#daterange-btn-surveys")
                        .data("daterangepicker")
                        .startDate.format("YYYY-MM-DD");
                    data.end_date = $("#daterange-btn-surveys")
                        .data("daterangepicker")
                        .endDate.format("YYYY-MM-DD");
                },
            },
    ...
    if ($("#general-user-surveys-table").length) {
        ...
        userSurveysTable = userSurveysTableEle.DataTable({
            ...
            columns: [
                ...
                {
                    data: "event.course.description",
                    name: "event.course.description",
                    orderable: false,
                },
                {
                    data: "action",
