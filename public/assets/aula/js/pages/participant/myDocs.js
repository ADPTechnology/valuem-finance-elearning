...
$(function () {
    ...
    var participantFilesTableEle = $("#participantFiles_table");
    var getDataTable = participantFilesTableEle.data('url')
    var participantFilesTable = participantFilesTableEle.DataTable({
            ...
            if (e.value === true) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            participantFilesTable.ajax.reload(null, false)
                            Toast.fire({
                                icon: 'success',
                                text: data.message,
                            })
